...
console.log(idades);
var workersRocketSeat = usuarios.filter(function (item) {
  return item.empresa === 'Rocketseat';
});
console.log(workersRocketSeat);
var workersGoogle = usuarios.find(function (item) {
  return item.empresa === 'Google';
});
console.log(workersGoogle);
var newUsers = usuarios.map(function (item) {
  item.idade = item.idade * 2;
  return item;
});
console.log(newUsers);
var minus50users = newUsers.filter(function (item) {
